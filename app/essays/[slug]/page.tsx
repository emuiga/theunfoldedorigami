...
import { UnfoldOnScroll } from "@/components/UnfoldOnScroll";
      ...
      <div className="relative z-10 min-h-screen pt-32">
        ...
        <div className="relative w-full h-[60vh] min-h-[400px]">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-serif text-[var(--color-text-primary)] text-center px-6 max-w-5xl leading-tight">
